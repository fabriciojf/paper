...
{
  public class DateTimeWidget : Widget, IHasMany, IHasRange, IHasOptions<DateTime>
  {
    public DateTimeWidget(string name)
      : base(name, KnownFieldDataTypes.Datetime)
    {
    }
    ...
    public string FormatOption(DateTime value) => value.ToString("dd/MM/yy HH:mm:ss");
  }
}