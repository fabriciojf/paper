...
namespace Paper.Media.Design.Widgets
{
  public abstract class Widget
  {
    ...
    /// </summary>
    public virtual string Type => (Hidden == true) ? FieldTypeNames.Hidden : _type;
    ...
    {
      var field = new Field();
      field._CopyFrom(this);

      // Verificando se o widget da suporte à interface IHasOptions<TOption>
      var options = field._Get<IEnumerable>("Options");
      if (options != null)
      {
        var values = field._Get<object[]>("Value");
        if (values == null)
        {
          var value = field._Get("Value");
