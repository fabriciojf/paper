...
namespace Paper.Media.Rendering
{
  static class RenderOfBasics
  {
    ...
    public static void Render(IPaper paper, IContext context, Entity entity)
    {
      ...
      RenderProperties(paper, context, entity);
      RenderLinks(paper, context, entity);
    ...
    private static void RenderProperties(IPaper paper, IContext context, Entity entity)
    {
    ...
    private static void RenderLinks(IPaper paper, IContext context, Entity entity)
    {
