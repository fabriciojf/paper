...
namespace Toolset
{
  ...
  public static class MimeTypes
  {
    ...
    /// </summary>
    /// <param name="filenameOrExtension">O nome do arquivo.</param>
    /// <param name="defaultMimeType">Valor padrão caso o mime type não seja detectado.</param>
    /// <returns>
    ...
    /// <summary>
    /// Lista as extensões possíveis para o mime type indicado.
    /// </summary>
    ...
    private static Dictionary<string, string> CreateCatalog()
    {
