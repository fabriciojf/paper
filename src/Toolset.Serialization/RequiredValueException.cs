...
{
  public class RequiredValueException : ValidationException
  {
    public RequiredValueException(Node parentNode, Node invalidNode)
    ...
    {
      var text = "O token requer um valor: " + invalidNode;
      if (parentNode != null)
      {
